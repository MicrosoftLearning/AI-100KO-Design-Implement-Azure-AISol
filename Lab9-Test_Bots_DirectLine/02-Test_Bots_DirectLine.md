...
1.  게시 대화 상자에서 **기존 항목 선택** 을 선택한 다음 **게시** 를 클릭합니다.

1.  메시지가 표시되면 랩을 통해 사용한 계정을 사용하여 로그인합니다.
...
1.  **비밀 키** 의 경우, **표시** 를 클릭하고 메모장이나 키를 추적하는 위치에 비밀 키 중 하나를 저장합니다. 
...
1.  [플랫폼의 기본 앱을 다운로드합니다](https://www.getpostman.com/apps). 간단한 계정을 만들어야 할 수도 있습니다.
...
1.  URL로 **https://directline.botframework.com/api/conversations/{conversationId}/messages** 를 입력합니다.  converstationId를 특정 대화 ID로 바꿔야 합니다.

1.  **권한 부여** 를 클릭하고 유형으로 **전달자 토큰** 을 선택합니다.
...
1.  콘솔 앱으로 새 대화를 만들고 사진을 검색해야 합니다. 
